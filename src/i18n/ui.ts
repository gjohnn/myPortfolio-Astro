...
export const ui: Record<Lang, Record<string, string>> = {
  es: {
    ...
    // ── Meta ──
    "meta.description":
      "Juan Sebastián Guerrero Britos - Desarrollador de Software especializado en C#, JS/TS y Docker. Desarrollo backend, APIs y soluciones cloud.",
    ...
    "hero.description.end":
      "Construyo soluciones limpias y mantenibles a través de la",
    ...
    "edu.associate.description":
      "Título técnico en Ciencias de la Computación con enfoque en desarrollo de software y principios de ingeniería.",
    "edu.linux.title": "Administrador GNU/Linux",
    "edu.linux.institution": "Certificación Profesional",
    "edu.linux.description":
      "Certificación avanzada en administración y gestión de sistemas Linux.",
    ...
    "edu.school.description":
      "Educación secundaria con especialización en Tecnología de la Información y sistemas informáticos.",
    "edu.english.title": "Certificación B2 en Inglés",
    "edu.english.institution": "Colegio de Lenguas Extranjeras",
    "edu.english.description":
      "Certificación de nivel intermedio-alto en inglés con enfoque en comunicación técnica y profesional.",

    // ── CTA (index) ──
    "cta.teamUp": "¡Hagamos equipo!",
    "cta.title": "¿Listo para trabajar juntos?",
    "cta.description":
      "Siempre estoy interesado en nuevas oportunidades y proyectos emocionantes. Hablemos sobre cómo podemos llevar tus ideas a la realidad.",
    ...
    "exp.subtitle":
      "Un recorrido por mi carrera profesional, mostrando los roles, responsabilidades y logros que han formado mi experiencia en desarrollo de software.",
    "exp.impressed": "¡Impresionado?",
    "exp.interestedTitle": "¿Interesado en Mi Experiencia?",
    "exp.interestedDesc":
      "Descarga mi currículum completo para información detallada sobre mi experiencia, habilidades y logros.",
    ...
    "contact.projectCollabDesc":
      "¿Buscas un desarrollador backend para tu próximo proyecto? Hablemos sobre cómo puedo ayudar a hacer realidad tus ideas.",
    "contact.jobOpportunities": "Oportunidades Laborales",
    "contact.jobOpportunitiesDesc":
      "Interesado en oportunidades full-time o freelance en desarrollo backend, APIs y soluciones cloud.",
    "contact.techDiscussion": "Discusión Técnica",
    "contact.techDiscussionDesc":
      "Siempre entusiasmado por discutir tecnología, compartir conocimiento y aprender de otros desarrolladores.",
    "contact.responseTime": "Usualmente responde en 24 horas",
    "contact.letsGo": "¡Vamos!",
    "contact.readyToStart": "¿Listo para comenzar tu proyecto?",
    "contact.readyDesc":
      "Ya sea que tengas un proyecto específico en mente o solo quieras explorar posibilidades, estoy aquí para ayudar a convertir tu visión en realidad.",
    ...
    "cv.mobileDesc":
      "Para una mejor experiencia de visualización en dispositivos móviles, descarga el PDF.",
    "cv.openPdf": "Abrir PDF",
    "cv.lastUpdated": "Última actualización:",

    // ── Footer ──
    "footer.description":
      "Desarrollador de Software especializado en desarrollo backend con C#, JS/TS y tecnologías cloud.",
  ...
  en: {
    ...
    // ── Meta ──
    "meta.description":
      "Juan Sebastián Guerrero Britos - Software Developer specialized in C#, JS/TS and Docker. Backend development, APIs and cloud solutions.",
    "meta.title": "Portfolio - Juan Sebastián Guerrero Britos",
    ...
    "edu.associate.institution": "UTN (Universidad Tecnológica Nacional)",
    "edu.associate.description":
      "Technical degree in Computer Science with focus on software development and engineering principles.",
    "edu.linux.title": "GNU/Linux Manager",
    "edu.linux.institution": "Professional Certification",
    "edu.linux.description":
      "Advanced Linux system administration and management certification.",
    "edu.school.title": "IT Orientation School",
    "edu.school.institution": "Escuela de Comercio Martin Zapata",
    "edu.school.description":
      "Secondary education with specialization in Information Technology and computer systems.",
    "edu.english.title": "B2 English Certification",
    "edu.english.institution": "Colegio de Lenguas Extranjeras",
    "edu.english.description":
      "Upper intermediate level English certification with focus on technical and professional communication.",
    ...
    "exp.subtitle":
      "A journey through my professional career, showcasing the roles, responsibilities, and achievements that have shaped my expertise in software development.",
    "exp.impressed": "Impressed?",
    "exp.interestedTitle": "Interested in My Background?",
    "exp.interestedDesc":
      "Download my complete resume for detailed information about my experience, skills, and accomplishments.",
    ...
    "contact.projectCollabDesc":
      "Looking for a backend developer for your next project? Let's talk about how I can help bring your ideas to life.",
    "contact.jobOpportunities": "Job Opportunities",
    "contact.jobOpportunitiesDesc":
      "Interested in full-time or freelance opportunities in backend development, APIs, and cloud solutions.",
    "contact.techDiscussion": "Technical Discussion",
    "contact.techDiscussionDesc":
      "Always excited to discuss technology, share knowledge, and learn from fellow developers.",
    "contact.responseTime": "Usually responds within 24 hours",
    "contact.letsGo": "Let's go!",
    "contact.readyToStart": "Ready to start your next project?",
    "contact.readyDesc":
      "Whether you have a specific project in mind or just want to explore possibilities, I'm here to help turn your vision into reality.",
    ...
    "cv.mobileDesc":
      "For the best viewing experience on mobile devices, please download the PDF.",
    "cv.openPdf": "Open PDF",
    "cv.lastUpdated": "Last updated:",

    // ── Footer ──
    "footer.description":
      "Software Developer specialized in backend development with C#, JS/TS, and cloud technologies.",
